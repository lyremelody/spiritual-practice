...
- [高可用架构设计](#高可用架构设计)
  ...
  - [5 高可用技术架构](#5-高可用技术架构)
    ...
    - [5.5 系统级高可用设计](#55-系统级高可用设计)
      - [5.5.1 存储高可用](#551-存储高可用)
        - [5.5.1.1 主备复制](#5511-主备复制)
        - [5.5.1.2 主从复制](#5512-主从复制)
        - [5.5.1.3 主备倒换与主从倒换](#5513-主备倒换与主从倒换)
          - [5.5.1.3.1 设计关键](#55131-设计关键)
          - [5.5.1.3.2 常见架构-互连式](#55132-常见架构-互连式)
          - [5.5.1.3.3 常见架构-中介式](#55133-常见架构-中介式)
          - [5.5.1.3.4 常见架构-模拟式](#55134-常见架构-模拟式)
        - [5.5.1.4 主主复制](#5514-主主复制)
        - [5.5.1.5 数据集群](#5515-数据集群)
          - [5.5.1.5.1 数据集中集群](#55151-数据集中集群)
          - [5.5.1.5.2 数据分散集群](#55152-数据分散集群)
        - [5.5.1.6 数据分区](#5516-数据分区)
          - [5.5.1.6.1 数据分区复制规则-集中式](#55161-数据分区复制规则-集中式)
          - [5.5.1.6.2 数据分区复制规则-互备式](#55162-数据分区复制规则-互备式)
          - [5.5.1.6.3 数据分区复制规则-独立式](#55163-数据分区复制规则-独立式)
      - [5.5.2 计算高可用](#552-计算高可用)
        - [5.5.2.1 主备架构](#5521-主备架构)
          - [5.5.2.1.1 冷备架构](#55211-冷备架构)
          - [5.5.2.1.2 温备架构](#55212-温备架构)
        - [5.5.2.2 主从架构](#5522-主从架构)
        - [5.5.2.3 对称集群](#5523-对称集群)
        - [5.5.2.4 非对称集群](#5524-非对称集群)
      - [5.5.3 常见组件的高可用方案](#553-常见组件的高可用方案)
        - [5.5.3.1 Kubernetes](#5531-kubernetes)
        - [5.5.3.2 MySQL](#5532-mysql)
        - [5.5.3.3 MariaDB](#5533-mariadb)
        - [5.5.3.4 MongoDB](#5534-mongodb)
        - [5.5.3.5 Redis](#5535-redis)
        - [5.5.3.6 Elasticsearch](#5536-elasticsearch)
        - [5.5.3.7 Kafka](#5537-kafka)
    - [5.6 区域级高可用设计](#56-区域级高可用设计)
      - [5.6.1 备份恢复](#561-备份恢复)
      - [5.6.2 异地多活](#562-异地多活)
