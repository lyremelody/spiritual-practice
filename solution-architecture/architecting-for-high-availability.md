...
- [高可用架构设计](#高可用架构设计)
  ...
  - [5 高可用技术架构](#5-高可用技术架构)
    - [5.1 高可用技术架构目标](#51-高可用技术架构目标)
      - [5.1.1 如何梳理可用性需求或者说可用性目标？](#511-如何梳理可用性需求或者说可用性目标)
    - [5.2 高可用架构实现机制](#52-高可用架构实现机制)
    - [5.3 高可用方案总览](#53-高可用方案总览)
      - [5.3.1 服务容错](#531-服务容错)
      - [5.3.2 计算高可用](#532-计算高可用)
      - [5.3.3 存储高可用](#533-存储高可用)
      - [5.3.4 业务高可用](#534-业务高可用)
      - [5.3.5 总结](#535-总结)
...
### 5.2 高可用架构实现机制
**本质**：通过冗余应对故障来实现高可用；通过伸缩来应对性能瓶颈实现高可用。
