...
- [OpenText Documentum 架构分析](#opentext-documentum-架构分析)
  ...
  - [2 OpenText Documentum](#2-opentext-documentum)
    ...
    - [2.4 组件(主要产品)说明](#24-组件主要产品说明)
      ...
      - [2.4.6 OpenText™ Extended ECM Documentum™ for Salesforce®](#246-opentext-extended-ecm-documentum-for-salesforce)
      - [2.4.7 OpenText™ Extended ECM Documentum™ for SAP® Solutions](#247-opentext-extended-ecm-documentum-for-sap-solutions)
      - [2.4.8 OpenText™ Documentum™ Integration with Microsoft®](#248-opentext-documentum-integration-with-microsoft)
      - [2.4.9 OpenText™ Documentum™ Add-Ons](#249-opentext-documentum-add-ons)
...
<div align=center><img src="./opentext-documentum/opentext_documentum_integration_with_microsoft.png"></div>
