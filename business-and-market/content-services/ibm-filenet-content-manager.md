...
- [IBM FileNet Content Manager 架构](#ibm-filenet-content-manager-架构)
  ...
  - [2 IBM FileNet Content Manager](#2-ibm-filenet-content-manager)
    ...
    - [2.5 可视化仪表盘和可扩展性](#25-可视化仪表盘和可扩展性)
      - [2.5.1 基于指标报告的License管理](#251-基于指标报告的license管理)
    - [2.6 可用性](#26-可用性)
    - [2.7 开放性](#27-开放性)
    - [2.8 适应性](#28-适应性)
  - [参考资料](#参考资料)
...
* **Rules Connectivity Framework**：为规则集成提供框架。 流程设计者或业务分析员使用第三方应用程序来创建业务规则，并将这些规则与工作流程的步骤相关联。 当正在运行的工作流程迂到规则时，工作流程系统会向规则监听器发送请求以执行规则集。 规则监听器执行规则集中的规则，并将结果返回到工作流程系统。 规则引擎提供程序必须实现特定 API 以与工作流程系统集成。
