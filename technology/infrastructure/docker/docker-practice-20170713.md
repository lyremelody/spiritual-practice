...
<strong><font color="red">最后修改于2017-07-13</font></strong>

- [那些年踩过的坑--Docker篇](#那些年踩过的坑--docker篇)
  - [容器时区问题](#容器时区问题)
  - [不要使用latest版本的镜像](#不要使用latest版本的镜像)
  - [镜像构建时间长](#镜像构建时间长)
    - [**自建Docker Registry**](#自建docker-registry)
    - [**构建基础镜像**](#构建基础镜像)
    - [**系统/库更新使用国内的源**](#系统库更新使用国内的源)
