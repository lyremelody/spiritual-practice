...
当然，业界对于「架构」也有很多种理解，我将在这篇文章中分享我对于「架构」这个概念的理解。
...
在 IT 领域，软件、硬件等产品是以物质(系统)形式交付，架构是这些系统的内在支撑，架构并不以物质形式存在，架构是抽象的概念。

以物质交付的系统，比如软件、硬件等产品，总是为了应对具体问题而生的。为了解决这些问题，思考如何构造系统来解决。
