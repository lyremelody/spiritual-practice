...
- [云原生是什么？](#云原生是什么)
  - [1 业界对于云原生的定义](#1-业界对于云原生的定义)
    - [1.1 Gartner](#11-gartner)
    - [1.2 CNCF](#12-cncf)
    - [1.3 Pivotal (VMware)](#13-pivotal-vmware)
    - [1.4 RedHat](#14-redhat)
      - [1.4.1 什么是云原生应用？](#141-什么是云原生应用)
      - [1.4.2 云原生应用中的“云”指的是什么？](#142-云原生应用中的云指的是什么)
      - [1.4.3 如何构建云原生应用？](#143-如何构建云原生应用)
  - [2 云原生技术解决的问题](#2-云原生技术解决的问题)
  - [3 云原生的优势](#3-云原生的优势)
    - [3.1 WPS 如何描述云原生优势](#31-wps-如何描述云原生优势)
    - [3.2 阿里云如何描述云原生和云原生的优势](#32-阿里云如何描述云原生和云原生的优势)
    - [3.3 《云原生模式》如何描述为什么需要云原生？](#33-云原生模式如何描述为什么需要云原生)
      - [3.3.1 零停机时间](#331-零停机时间)
      - [3.3.2 缩短反馈周期](#332-缩短反馈周期)
      - [3.3.3 移动端和多设备支持](#333-移动端和多设备支持)
      - [3.3.4 互联设备 (物联网)](#334-互联设备-物联网)
      - [3.3.5 数据驱动](#335-数据驱动)
  - [4 云原生发展史](#4-云原生发展史)
  - [5 我对于云原生的理解](#5-我对于云原生的理解)
  - [参考资料](#参考资料)
