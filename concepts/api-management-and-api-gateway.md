...
- [API管理与API网关](#api管理与api网关)
  ...
  - [3 微服务模式：API Gateway / Backends for Frontends](#3-微服务模式api-gateway--backends-for-frontends)
    ...
    - [3.2 API网关变种：Backends for Frontends](#32-api网关变种backends-for-frontends)
...
* 你希望保护API免受过度使用和滥用，因此选择了身份验证服务和速率限制。
* 你想了解人们如何使用你的API，因此添加了分析和监控工具。
...
### 3.2 API网关变种：Backends for Frontends
...
3. [什么是 API 管理？，RedHat](https://www.redhat.com/zh/topics/api/what-is-api-management)
4. [【API 管理】什么是 API 管理，为什么它很重要？，腾讯云](https://cloud.tencent.com/developer/article/1972706)
5. [网关，wikipedia](https://zh.wikipedia.org/zh-cn/%E7%BD%91%E5%85%B3)
6. [云原生时代，API 网关为何如此重要？，CSDN](https://blog.csdn.net/csdnnews/article/details/127382842)
7. [API 网关能做什么？，RedHat](https://www.redhat.com/zh/topics/api/what-does-an-api-gateway-do)
