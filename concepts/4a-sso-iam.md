...
全景图如下：
<div align=center><img src="./4a-sso-iam/OAuth2.0.png"></div>

##### 2.4.1.1 安全问题：凭据共享与凭据盗用
...
##### 2.4.1.2 OAuth 2.0 解决问题的关键思想：角色分离、授权访问、访问控制
...
8. [【涨知识】认识IAM，向着“零信任”安全架构迈进](https://mp.weixin.qq.com/s/PneehAwkLRt8gtoMmpdmjQ)
9. [什么是身份和访问管理（IAM）？](https://blog.csdn.net/yuzijiang11111/article/details/123273176)
10. [RFC6749: The OAuth 2.0 Authorization Framework](https://datatracker.ietf.org/doc/html/rfc6749)